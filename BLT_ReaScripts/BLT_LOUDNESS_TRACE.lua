-- @description LOUDNESS TRACE - stereo master/track loudness in the arrange view
-- @version 0.5.0
-- @about
--   Windows / macOS (experimental) / REAPER 7.79+ / SWS / js_ReaScriptAPI.
--   Measures a time selection via temporary stereo 48 kHz float render.
--   LUFS-S, M, cumulative Integrated, EBU Loudness Range; optional RMS and sample peak.
--   Display data is embedded in the project. No background audio analysis.
--   The controller can collapse to a compact bar while the arrange-view graph stays active.
