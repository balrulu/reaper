-- @description Simple Normalizer - selectable normalization methods
-- @version 0.5.0
-- @about Simple, non-destructive item-gain normalization for REAPER.
-- @about Custom title bar requires js_ReaScriptAPI.
-- @about Methods: Sample Peak / LUFS-I / LUFS-M / LUFS-S / Speech / Median / Robust / P80 / P95 / Max 1s.
-- @about Target: absolute value or a reference item chosen from the list. Analysis follows the current selection automatically.
-- @about Finished items appear immediately; Normalize can be pressed before background analysis completes.
...
local function draw()
  ...
  BLT.footer(msg,A.bad,W,H+22,'0.5.0',prog)
  custom_titlebar()
end
