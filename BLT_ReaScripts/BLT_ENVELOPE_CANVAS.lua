-- @description BLT: Envelope Canvas - draw pitch, speed, volume and filter curves
-- @version 0.5.0
-- @about
--   Native gfx BLT glass HUD / js_ReaScriptAPI. REAPER 7+.
--   One selected audio item; first valid active audio take in selection order.
--   Selection transforms, freehand and positioned line generation; bounded chaos.
--   Apply is live take processing. Use REAPER Undo for audio changes.
--   External item edits become a new baseline while preserving the shared drawing.
